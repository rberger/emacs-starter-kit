...
(add-to-extra-classpath (concat *FURTIVE-ROOT* "/lib/clojure/clj-utils/lib/java/*"))
...
(add-to-extra-classpath (concat *FURTIVE-ROOT* "/lib/clojure/redis-clojure/src/main/clojure/"))
